<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="ProductImg" v-model="item.productImg" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Number label="Stock" v-model="item.stock" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Date label="RegisterDt" v-model="item.registerDt" :editMode="editMode" @change="change" />
            </div>
            <div>
