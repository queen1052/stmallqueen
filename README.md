...
## Model
www.msaez.io/#/courses/cna-full/c42d09d0-5e08-11ef-9d8f-09c27e85e401/design-event
...
- delivery
```
 http :8088/deliveries id="id" orderId="orderId" userId="userId" productName="productName" qty="qty" deliveryDate="deliveryDate" status="status" 
```
- customercenter
```
```
